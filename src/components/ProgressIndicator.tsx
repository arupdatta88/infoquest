    ...
    <div className="animate-fade-in-up flex flex-col items-center gap-5 py-10">
      <div className="relative h-16 w-16">
        <svg viewBox="0 0 64 64" className="h-16 w-16 animate-spin-slow">
          <circle cx="27" cy="27" r="13" stroke="#065F46" strokeWidth="4" fill="none" opacity="0.15" />
          <path d="M27 14 A13 13 0 0 1 40 27" stroke="#10B981" strokeWidth="4" fill="none" strokeLinecap="round" />
          <line x1="36" y1="36" x2="50" y2="50" stroke="#065F46" strokeWidth="5" strokeLinecap="round" opacity="0.35" />
        </svg>
      </div>
